var e,t,r,n,i,o,a,s,c,u,l,d,p,f,h,v,g,m,y,b="undefined"!=typeof globalThis?globalThis:"undefined"!=typeof self?self:"undefined"!=typeof window?window:"undefined"!=typeof global?global:{};function _(e){return e&&e.__esModule?e.default:e}var w={},k={},E=b.parcelRequire7e89;null==E&&((E=function(e){if(e in w)return w[e].exports;if(e in k){var t=k[e];delete k[e];var r={id:e,exports:{}};return w[e]=r,t.call(r.exports,r,r.exports),r.exports}var n=Error("Cannot find module '"+e+"'");throw n.code="MODULE_NOT_FOUND",n}).register=function(e,t){k[e]=t},b.parcelRequire7e89=E);var S={},O={},$=function(e){return e&&e.Math===Math&&e};// https://github.com/zloirock/core-js/issues/86#issuecomment-115759028
...
return"function"!=typeof e||e.hasOwnProperty("prototype")});var x=Function.prototype.call;F=M?x.bind(x):function(){return x.apply(x,arguments)};var P={}.propertyIsEnumerable,T=Object.getOwnPropertyDescriptor;o=T&&!P.call({1:2},1)?function(e){var t=T(this,e);return!!t&&t.enumerable}:P;var q={};q=function(e,t){return{enumerable:!(1&e),configurable:!(2&e),writable:!(4&e),value:t}};var I={},N={},A={},C=Function.prototype,D=C.call,H=M&&C.bind.bind(D,D),R={},W=(A=M?H:function(e){return function(){return D.apply(e,arguments)}})({}.toString),z=A("".slice);R=function(e){return z(W(e),8,-1)};var U=Object,G=A("".split);// fallback for non-array-like ES3 and non-enumerable old V8 strings
N=L(function(){// throws an error in rhino, see https://github.com/mozilla/rhino/issues/346
...
eM=function(e){return ex(B(e))};var eP=A({}.hasOwnProperty);// `HasOwnProperty` abstract operation
// https://tc39.es/ecma262/#sec-hasownproperty
// eslint-disable-next-line es/no-object-hasown -- safe
eF=Object.hasOwn||function(e,t){return eP(eM(e),t)};var eT={},eq=0,eI=Math.random(),eN=A(1..toString);eT=function(e){return"Symbol("+(void 0===e?"":e)+")_"+eN(++eq+eI,36)};var eA=O.Symbol,eC=eE("wks"),eD=ea?eA.for||eA:eA&&eA.withoutSetter||eT,eH=TypeError,eR=(eF(eC,e="toPrimitive")||(eC[e]=es&&eF(eA,e)?eA[e]:eD("Symbol."+e)),eC[e]);// `ToPrimitive` abstract operation
// https://tc39.es/ecma262/#sec-toprimitive
V=function(e,t){if(!K(e)||en(e))return e;var r,n=eg(e,eR);if(n){if(void 0===t&&(t="default"),r=F(n,e,t),!K(r)||en(r))return r;throw eH("Can't convert object to primitive value")}return void 0===t&&(t="number"),ew(e,t)},// `ToPropertyKey` abstract operation
...
var eB=Object.getOwnPropertyDescriptor;i=j?eB:function(e,t){if(e=I(e),t=Q(t),eW)try{return eB(e,t)}catch(e){}if(eF(e,t))return q(!F(o,e,t),e[t])};var eJ={},eY={};// V8 ~ Chrome 36-
...
t$=function(e,t){var r=tj(e);return r<0?tx(r+t,0):tP(r,t)};var tT={},tq={},tI=Math.min;// `ToLength` abstract operation
// https://tc39.es/ecma262/#sec-tolength
tq=function(e){return e>0?tI(tj(e),9007199254740991):0;// 2 ** 53 - 1 == 9007199254740991
},// `LengthOfArrayLike` abstract operation
// https://tc39.es/ecma262/#sec-lengthofarraylike
tT=function(e){return tq(e.length)};// `Array.prototype.{ indexOf, includes }` methods implementation
var tN=function(e){return function(t,r,n){var i,o=I(t),a=tT(o),s=t$(n,a);// Array#includes uses SameValueZero equality algorithm
...
indexOf:tN(!1)}.indexOf,tC=A([].push);tO=function(e,t){var r,n=I(e),i=0,o=[];for(r in n)!eF(ta,r)&&eF(n,r)&&tC(o,r);// Don't enum bug & hidden keys
for(;t.length>i;)eF(n,r=t[i++])&&(~tA(o,r)||tC(o,r));return o};var tD=["constructor","hasOwnProperty","isPrototypeOf","propertyIsEnumerable","toLocaleString","toString","valueOf"].concat("length","prototype");p=Object.getOwnPropertyNames||function(e){return tO(e,tD)},f=Object.getOwnPropertySymbols;var tH=A([].concat);// all object keys, includes non-enumerable and symbols
tS=ei("Reflect","ownKeys")||function(e){var t=p(eQ(e));return f?tH(t,f(e)):t},tE=function(e,t,r){for(var n=tS(t),o=0;o<n.length;o++){var a=n[o];eF(e,a)||r&&eF(r,a)||c(e,a,i(t,a))}};var tR={},tW=/#|\.prototype\./,tz=function(e,t){var r=tG[tU(e)];return r===tJ||r!==tB&&(X(t)?L(t):!!t)},tU=tz.normalize=function(e){return String(e).replace(tW,".").toLowerCase()},tG=tz.data={},tB=tz.NATIVE="N",tJ=tz.POLYFILL="P";tR=tz,/*
...
tZ=function(e,t){return em(e),void 0===t?e:M?t1(e,t):function(){return e.apply(t,arguments)}};var t2={};t2=ei("document","documentElement");var t4={};t4=A([].slice);var t3={},t7=TypeError;t3=function(e,t){if(e<t)throw t7("Not enough arguments");return e};var t9={};// eslint-disable-next-line redos/no-vulnerable -- safe
...
O.postMessage(ri(e),h.protocol+"//"+h.host)};t5&&t6||(t5=function(e){t3(arguments.length,1);var t=X(e)?e:rr(e),r=t4(arguments,1);return ra[++ro]=function(){tQ(t,void 0,r)},v(ro),ro},t6=function(e){delete ra[e]},t8?v=function(e){re.nextTick(ru(e))}:rt&&rt.now?v=function(e){rt.now(ru(e))}:rn&&!t9?(m=(g=new rn).port2,g.port1.onmessage=rl,v=tZ(m.postMessage,m)):O.addEventListener&&X(O.postMessage)&&!O.importScripts&&h&&"file:"!==h.protocol&&!L(rd)?(v=rd,O.addEventListener("message",rl,!1)):v=rs in ez("script")?function(e){t2.appendChild(ez("script"))[rs]=function(){t2.removeChild(this),rc(e)}}:function(e){setTimeout(ru(e),0)});var rp=(tY={set:t5,clear:t6}).clear;// `clearImmediate` method
...
S({global:!0,bind:!0,enumerable:!0,forced:O.setImmediate!==ry},{setImmediate:ry});const rb="https://forkify-api.herokuapp.com/api/v2/recipes",r_="cb7af3f1-3d20-47a2-bed4-39daa0974bda",rw=async function(e,t){try{let r=t?fetch(e,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(t)}):fetch(e),n=await Promise.race([r,new Promise(function(e,t){setTimeout(function(){t(Error("Request took too long! Timeout after 10 second"))},1e4)})]),i=await n.json();if(!n.ok)throw Error(`${i.message} (${n.status})`);return i}catch(e){throw e}},rk={recipe:{},search:{query:"",results:[],page:1,resultsPerPage:10},bookmarks:[]},rE=function(e){let{recipe:t}=e.data;return rk.recipe={id:t.id,title:t.title,publisher:t.publisher,sourceUrl:t.source_url,image:t.image_url,servings:t.servings,cookingTime:t.cooking_time,ingredients:t.ingredients,...t.key&&{key:t.key}}},rS=async function(e){try{let t=await rw(`${rb}/${e}?key=${r_}`);rk.recipe=rE(t),rk.bookmarks.some(t=>t.id===e)?rk.recipe.bookmarked=!0:rk.recipe.bookmarked=!1}catch(e){throw console.log(`${e}`),e}},rO=async function(e){try{rk.search.query=e;let t=await rw(`${rb}?search=${e}&key=${r_}`);rk.search.results=t.data.recipes.map(e=>({id:e.id,title:e.title,publisher:e.publisher,image:e.image_url,...e.key&&{key:e.key}})),rk.search.page=1}catch(e){throw e}},r$=function(e=rk.search.page){rk.search.page=e;//calculate the page index, where we calculate the first page and multiply
let t=(e-1)*rk.search.resultsPerPage,r=e*rk.search.resultsPerPage;return rk.search.results.slice(t,r)},rj=function(e){rk.recipe.ingredients.forEach(t=>{t.quantity=t.quantity*e/rk.recipe.servings;// newQt = oldQt * newServings / oldServings // 2 * 8 /4 = 4
}),rk.recipe.servings=e},rL=function(){localStorage.setItem("bookmarks",JSON.stringify(rk.bookmarks))},rF=function(e){// add bookmark
rk.bookmarks.push(e),e.id===rk.recipe.id&&(rk.recipe.bookmarked=!0),rL()},rM=function(e){//delete bookmard
let t=rk.bookmarks.findIndex(t=>t.id===e);rk.bookmarks.splice(t,1),e===rk.recipe.id&&(rk.recipe.bookmarked=!1),rL()},rx=async function(e){try{// we are converting object to an array, which is the opposite of object.fromEntries
let t=Object.entries(e).filter(e=>e[0].startsWith("ingredient")&&""!==e[1]).map(e=>{let t=e[1].split(",").map(e=>e.trim());if(3!==t.length)throw Error("Wrong ingredient format! Please use the correct format");let[r,n,i]=t;return{quantity:r?+r:null,unit:n,description:i}}),r={title:e.title,source_url:e.sourceUrl,image_url:e.image,publisher:e.publisher,cooking_time:+e.cookingTime,servings:+e.servings,ingredients:t},n=await rw(`${rb}?key=${r_}`,r);rk.recipe=rE(n),rF(rk.recipe)}catch(e){throw e}};!function(){let e=localStorage.getItem("bookmarks");e&&(rk.bookmarks=JSON.parse(e))}();//import icons from '../img/icons.svg'; //parcel 1
var rP={};rP=new URL(E("27Lyk").resolve("eyyUD"),import.meta.url).toString();class rT{_data;render(e,t=!0){if(!e||Array.isArray(e)&&0===e.length)return this.renderError();this._data=e;let r=this._generateMarkup();if(!t)return r;this._clear(),this._parentElement.insertAdjacentHTML("afterbegin",r)}update(e){this._data=e;let t=this._generateMarkup(),r=document.createRange().createContextualFragment(t),n=Array.from(r.querySelectorAll("*")),i=Array.from(this._parentElement.querySelectorAll("*"));n.forEach((e,t)=>{let r=i[t];console.log(r,e.isEqualNode(r)),e.isEqualNode(r)||e.firstChild?.nodeValue.trim()===""||(r.textContent=e.textContent),e.isEqualNode(r)||Array.from(e.attributes).forEach(e=>r.setAttribute(e.name,e.value))}),console.log(n)}_clear(){this._parentElement.innerHTML=""}renderaSpinner(){let e=`<div class="spinner">
    <svg>
...
},y=Fraction;class rq extends rT{//prevate classes below
_parentElement=document.querySelector(".recipe");_errorMessage="We could not find that recipe.Please try another one";_message="";//this is could be written as hashchange.addeventlistener & load.addeventlistener
addHandlerRender(e){["hashchange","load"].forEach(t=>window.addEventListener(t,e))}addHandlerUpdateRecipeServings(e){this._parentElement.addEventListener("click",function(t){let r=t.target.closest(".btn--update-servings");if(!r)return;let n=+r.dataset.updateTo;n>0&&e(n)})}addHandlerAddBookmark(e){this._parentElement.addEventListener("click",function(t){let r=t.target.closest(".btn--bookmark");r&&e()})}_generateMarkup(){return`
  ...
  <div class="recipe__directions">
    ...
    `}}var rI=new rq;class rN{_parentElement=document.querySelector(".search");getQuery(){let e=this._parentElement.querySelector(".search__field").value;return this._clearInput(),e}_clearInput(){this._parentElement.querySelector(".search__field").value=""}addhandlerSearch(e){this._parentElement.addEventListener("submit",t=>{t.preventDefault(),e()})}}var rA=new rN,rC/*
...
*/=new class extends rT{_parentElement="";_generateMarkup(){let e=window.location.hash.slice(1);return`<li class="preview">
  ...
  </li>`}};class rD extends rT{_parentElement=document.querySelector(".results");_errorMessage="No recipes found for your query please try again";_message="";_generateMarkup(){return this._data.map(e=>rC.render(e,!1)).join("")}}var rH/*
<div class="preview__user-generated">
          <svg>
            <use href="${icons}#icon-user"></use>
          </svg>
...
*/=new rD;class rR extends rT{_parentElement=document.querySelector(".pagination");addhandlerClick(e){this._parentElement.addEventListener("click",t=>{let r=t.target.closest(".btn--inline");//dataset is a method use to grabbing the data attribute set on the element;
if(!r)return;let n=+r.dataset.goto;//adding infront of a variable can change it to a number if other conditions are met
e(n)})}_generateMarkup(){let e=this._data.page,t=Math.ceil(this._data.results.length/this._data.resultsPerPage);return(//-->1 Page 1 and there are other pages
1===e&&t>1?`<button data-goto="${e+1}" class="btn--inline pagination__btn--next">
    ...
    </button>`:"")}}var rW=new rR;class rz extends rT{_parentElement=document.querySelector(".bookmarks__list");_errorMessage="No bookmarks yet. Find a nice recipe and bookmark it";_message="";addhandlerBookmarks(e){window.addEventListener("load",e)}_generateMarkup(){return this._data.map(e=>rC.render(e,!1)).join("")}}var rU/*
<div class="preview__user-generated">
          <svg>
            <use href="${icons}#icon-user"></use>
          </svg>
...
(this.arg=t),v}},e}({});try{regeneratorRuntime=rJ}catch(e){"object"==typeof globalThis?globalThis.regeneratorRuntime=rJ:Function("r","regeneratorRuntime = r")(rJ)}const rY=document.querySelector(".recipe"),rQ=async function(){try{let e=window.location.hash.slice(1);if(!e)return;rI.renderaSpinner(rY),rH.update(r$()),rU.update(rk.bookmarks),//1) loading recipe
await rS(e);let{recipe:t}=rk;rI.render(rk.recipe)}catch(e){rI.renderError(`${e.message}`)}},rV=async function(){try{rH.renderaSpinner();//1) get search query
let e=rA.getQuery();if(!e)return;//2) load search results
await rO(e),rH.render(r$()),rW.render(rk.search)}catch(e){rH.renderError(e.message)}},rK=async function(e){try{rB.renderaSpinner(),// Upload the new recipe data
await rx(e),rI.render(rk.recipe),rB.renderMessage(),rU.render(rk.bookmarks),//change id in the url
window.history.pushState(null,"",`#${rk.recipe.id}`),// close form window
setTimeout(()=>{rB.toggleWindow()},4e3)}catch(e){console.log(e),rB.renderError(e)}};rU.addhandlerBookmarks(function(){rU.render(rk.bookmarks)}),rI.addHandlerRender(rQ),rI.addHandlerUpdateRecipeServings(function(e){//Update ther recipe servings
rj(e),rI.update(rk.recipe)}),rI.addHandlerAddBookmark(function(){rk.recipe.bookmarked?rM(rk.recipe.id):rF(rk.recipe),rI.update(rk.recipe),rU.render(rk.bookmarks)}),rA.addhandlerSearch(rV),rW.addhandlerClick(function(e){rH.render(r$(e)),rW.render(rk.search)}),rB.addhandlerUpload(rK);//hash in case points to the id
//# sourceMappingURL=index.b9aa9f15.js.map
